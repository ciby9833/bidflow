...
const routes = [
  ...
  { path: '/select-branch', component: () => import('../views/auth/BranchSelectView.vue'), meta: { public: true } },
  ...
  { path: '/supplier/review-pending', component: () => import('../views/supplier/SupplierReviewPendingView.vue') },
  {
    ...
    children: [
      ...
      { path: 'organization/branches', component: () => import('../views/organization/BranchManageView.vue'), meta: { title: 'organization' } },
