...
export enum AuditAction {
  ...
  TENDER_DEADLINE_CHANGE = 'TENDER_DEADLINE_CHANGE',
  ...
  /** 授予/撤销供应商在某机构的准入资格，是多机构下的独立业务动作，不与审核状态混用 */
  SUPPLIER_BRANCH_GRANT = 'SUPPLIER_BRANCH_GRANT',
  SUPPLIER_BRANCH_REVOKE = 'SUPPLIER_BRANCH_REVOKE',
